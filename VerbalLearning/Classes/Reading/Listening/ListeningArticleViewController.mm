//
//  ListeningArticleViewController.m
//  VerbalLearning
//
...
@interface ListeningArticleViewController ()
{
...
- (void)displayLesson
{
    ...
    NSMutableString *contentText = [[NSMutableString alloc] initWithCapacity:0] ;
    for (Sentence *sentence in self.sentencesArray) {
        NSRange sentenceRange = NSMakeRange(contentText.length, sentence.orintext.length);
