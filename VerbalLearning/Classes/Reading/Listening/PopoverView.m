...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.backgroundView.backgroundColor = [UIColor colorWithRed:0.19 green:0.21 blue:0.22 alpha:1];
...
- (void)drawRect:(CGRect)rect
{
    ...
    //填充颜色
    [[UIColor colorWithRed:0.19 green:0.21 blue:0.22 alpha:1] setFill];
    [popoverPath fill];
